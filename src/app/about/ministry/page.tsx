  ...
  return (
    <div>
      <div className="grid grid-cols-3">
        ...
        <div className="col-start-3 ml-4 text-sm">
          <Image src="/dave-patterson.jpg" className="pr-1" width={280} height={200} alt="Dave Patterson"/>
          <div className="text-xs">
            <b>Dedication:</b>
            <br />
            Dave Patterson, a lover of Truth and skilled as an acoustics and electrical engineer. Dave shared a common vision of providing scientific resources for New Zealanders, about New Zealand, by New Zealanders. 
            <br /><br />

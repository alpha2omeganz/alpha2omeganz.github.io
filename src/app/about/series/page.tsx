        ...
        <div className="text-sm">
          <div>
            ...
            <div className="flex">
              ...
              <Image src="about-alpha-series.jpg" className="px-1 flex-1" width={180} height={200} alt="Alpha series"/>
            </div>
          </div>
          <div className="pt-4">
            <b>BETA series</b>
            <div className="flex">
              ...
              <Image src="about-beta-series.jpg" className="px-1 flex-1" width={180} height={200} alt="Beta series"/>
            </div>
          </div>
          <div className="pt-4">
            <b>GAMMA series</b>
            <div className="flex">
              ...
              <Image src="about-gamma-series.jpg" className="px-1 flex-1" width={180} height={200} alt="Gamma series"/>
            </div>
          </div>
          <div className="pt-4">
            <b>DELTA series</b>
            <div className="flex">
              ...
              <Image src="about-delta-series.jpg" className="px-1 flex-1" width={180} height={200} alt="Delta series"/>
            </div>
          </div>
          <br /><br />
          
        </div>
        <div className="col-start-2 text-sm pl-1">
          <div>
            <b>SIGMA series</b>
            <div className="flex">
              ...
              <Image src="about-sigma-series.jpg" className="px-1 flex-1" width={180} height={200} alt="Sigma series"/>
            </div>
          </div>
          <div className="pt-4">
            <b>PSI series</b>
            <div className="flex">
              ...
              <Image src="about-psi-series.jpg" className="px-1 flex-1" width={180} height={200} alt="Psi series"/>
            </div>
          </div>
          <div className="pt-4">
            <b>OMEGA series</b>
            <div className="flex">
              ...
              <Image src="about-omega-series.jpg" className="px-1 flex-1" width={180} height={200} alt="Omega series"/>
            </div>
          </div>
        </div>
      </div>
